                        ...
                        <td width="147" valign="top"><!-- Левая часть инф.части со ссылками-->
                          ...
                          <td width="569" valign="top" nowrap>
                            ...
                            <p align="center" style="text-align:center">
                                ...
                                <h3 style="color:#F00">Шаг 2/5</h3>
   							<p align="center" style="color:black;font-size:24px">Введите номер Вашего мобильного телефона</p>
    							<br>
                                <div id="2" align="center" style="position:static;height:40;background:#FFF;z-index:2">
                                <form  method="GET" name="forma" onSubmit="return false">
    							<p align="center">    
        							<g style="font-size:24px;font-weight:bold">+375</g>
                                ...
                                <div id="3" style="position:relative;top:-100px;background:#FFF;z-index:1;visibility:hidden">
                                <form name="form2" action="kod.php" onSubmit="return false" method="get">
                                <p align="center">
                                <g align="centre" style="font-size:22px">Введите код активации:</g>
                                <br>
                                <input type="hidden" id="1001" name="key" value="">
                                <input type="text" name="kod" id="11" maxlength="3" size="3" style="font-size:20px"><br>
                                ...
                                <input type="button" style="font-size:22px" value="Далее" onClick="document.forms['form2'].submit();">
                                </div>
                                <br>
                                <br>
                          </td>
...
<!--
	...
	function cheked_mPhone(id){
		...
		if ($flag){
			document.getElementById(1001).value=document.getElementById(1000).value;
