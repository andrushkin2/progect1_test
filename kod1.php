                          ...
                          <td width="569" valign="top" nowrap>
                            ...
                            <p align="center" style="text-align:center">
                                ...
                                <?php
									...
									$num=$_GET['num'];
									$allPhone=$phone;
									echo "<form method=GET name=form2 action=kod1.php>";
    							...
    							{	
									...
									if (!($h < 21&&$h >= 9)){
										echo "<div id=10001 align=center style=position:relative;background-color:#FFF;top:0px;visibility:visible;z-index:3>
                            				<p align=center>
                                			<g align=centre style=font-size:24px>Отписка возможна с 9.00 до 21.00</g>
                                			<br>
...
//  } 
								...
								{
									mysql_query("UPDATE dBase set record ='0' where phone='$allPhone' and num='$num'");//tut
									$avalible="select * from dBase where phone='$allPhone' and num='$num'";//tut
									$res=mysql_query($avalible);
									$row=mysql_fetch_array($res);
									...
									echo "<div id=10001 align=center style=position:relative;background-color:#FFF;top:0px;visibility:visible;z-index:3>
                            				<p align=center>
                                			<g align=centre style=font-size:24px>$fam1 $name1, вы успешно отписаны от занятия.</g>
                                			<br>
                                			<a href=//salto.extreme.by><input type=button border=2 style=font-size:22px value=Выход></a>
                            				</p>
                            				<br><br><br><br><br>
                            				</div>";
