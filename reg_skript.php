...
<title>Регистрация:подтверждение</title>
<style type="text/css">
                            ...
                            <p align="center" style="text-align:center">
   							...
   							<p style="color:#F00;font-size:20px">Регистрация:</p>
                                ...
                                require("config.php");
									...
									if ($t!=1){
									echo "<p style=font-size:22px;padding-left:180px>Фамилия: $fam</p>";
									echo "<p style=font-size:22px;padding-left:180px>Имя: $name</p>";
									echo "<p style=font-size:22px;padding-left:180px>Год рождения: $age</p>";
									echo "<form method=GET id=1 action=finnaly_page.php>";
									echo "<input type=hidden name=num value=$num>";
									echo "<input type=hidden id=10 name=first value=$name>";
									echo "<input type=hidden id=11 name=fam value=$fam>";
									echo "<input type=hidden id=12 name=age value=$age>";
									echo "<input type=hidden id=13 name=phone value=$phone>";
									echo "<input type=submit id=15 value=submit style=visibility:hidden>";
									echo "<p style=;padding-left:155px><input type=button style=font-size:22px id=14 value=Записаться onClick=writ()><g style=visibility:hidden>aaaa</g><input type=button style=font-size:22px id=14 value=\"Изменить данные\" onClick=change()></p>";
									echo "</form>";
									}
									else{
										echo "<p style=font-size:22px;padding-left:180px>Фамилия: $fam</p>";
...
<!--
function change(){
	document.getElementById(1).action="Registration.php";
